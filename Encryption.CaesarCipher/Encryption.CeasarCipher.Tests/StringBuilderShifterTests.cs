...
{
    public class StringBuilderShifterTests
    {
        [Fact]
        public void ShouldReturnCorrectValue()
        {
            ...
            IStringShifter service = new StringBuilderStringShifter(shift, input);
        ...
        public void ShouldThrowException()
        {
            ...
            // Act
            // Assert
            Assert.Throws<Exception>(() => new StringBuilderStringShifter(shift, input));
